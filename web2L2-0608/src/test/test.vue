<template>
  <div>
    <h1  style="text-align:center;color:white">疫情实时查看</h1>
    <!-- <iframe src="https://ncov.dxy.cn/ncovh5/view/pneumonia_timeline" style="width:800px;height: 600px;border: 0" v-if="flag==7"></iframe> -->
    <div id="china_map" style='width:600px;height:600px;'> </div>
  </div>
</template>
<script>
...
export default {
  ...
  this.chinachart.setOption(this.chartOption)
    ...
    methods:{
            getMessage(){
                let that = this;
                this.axios.get('http://localhost:8000/login').then(res=>{
